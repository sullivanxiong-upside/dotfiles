...
return {
		...
		opts = {
			defaults = {
				...
				vimgrep_arguments = {
					...
					"--hidden",
					"--no-ignore-vcs",
					-- Exclude large directories that kill performance
					"--glob=!node_modules/",
					"--glob=!.venv/",
					"--glob=!venv/",
					"--glob=!.devenv/",
			...
			pickers = {
				find_files = {
					find_command = { "rg", "--files", "--hidden", "--no-ignore-vcs", "--glob=!.git/", "--glob=!node_modules/", "--glob=!.venv/", "--glob=!venv/", "--glob=!.devenv/", "--glob=!__pycache__/", "--glob=!vendor/", "--glob=!build/", "--glob=!dist/", "--glob=!.cache/" },
				},
			},
		},
	},
	...
	-- markdown-preview.nvim
	{
		...
		ft = { "markdown" },
		-- Using npm is often more reliable than the pre-built installer
